...
def upgrade() -> None:
    ...
    op.create_table('videos',
        ...
        sa.Column('status', sa.Enum('UPLOADING', 'UPLOADED', 'PROCESSING', 'READY', 'FAILED', name='videostatus'), nullable=True),
        sa.Column('visibility', sa.Enum('PUBLIC', 'PRIVATE', 'UNLISTED', name='visibility'), nullable=True),
    ...
    op.create_table('processing_tasks',
        sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
        sa.Column('video_id', sa.Integer(), nullable=False),
        sa.Column('task_type', sa.Enum('TRANSCODE', 'THUMBNAIL', 'METADATA', name='processingtasktype'), nullable=False),
        sa.Column('priority', sa.Integer(), nullable=True),
        sa.Column('celery_task_id', sa.String(length=255), nullable=True),
        sa.Column('status', sa.Enum('PENDING', 'PROCESSING', 'SUCCESS', 'FAILED', name='taskstatus'), nullable=True),
